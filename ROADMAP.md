...
*(אין משימה פעילה. אוולין: v1 מתמטיקה + הבנת הנקרא הושלמו. ההמשך
הוא או הבנת הנקרא לאמיליה או מסלול אנגלית.)*

---

## 🟡 הבא (תוך 1–2 שבועות)

1. **CORE-HEBREW-EMILIA-001** — הבנת הנקרא לאמיליה (טקסטים מאתגרים +
   הסקה מתקדמת + אוצר מילים).
